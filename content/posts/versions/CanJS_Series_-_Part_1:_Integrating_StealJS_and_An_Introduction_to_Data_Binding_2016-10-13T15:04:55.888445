In this first part of a 4 part series on CanJS, I'm going to cover the process of building a simple app from scratch using the [StealJS](http://stealjs.com/) module loader. Additionally, for the sake of fun, I'll cover data-binding.
